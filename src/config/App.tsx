...
import { Button, FormControlLabel, Grid, MenuItem, Switch, TextField, Tooltip } from '@material-ui/core';
  ...
  return (
    <div className={classes.root}>
      <div className={classes.configContainer}>
        ...
        <Button color='primary' onClick={addRow} startIcon={<AddIcon />}>
          行を追加
        </Button>
      </div>
